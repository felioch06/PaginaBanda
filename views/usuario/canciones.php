                    ...
                    <div class="twelve wide column">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="ui center aligned">
                              <a href="" class="ui green button">Terminada</a>
                              <a href="" class="ui blue button">Actualizar</a>
                              <button class="ui red button modal-eliminar-cancion" data-id="<?php echo $cancion->id_cancion ?>">Eliminar</button>
                            </td>
                          </tr>
                        ...
                        <div class="ui agregar modal">
                          ...
                          <div class="content">
                            ...
                            <div class="ui fluid icon input">
                              <input type="text" name="nombre_cancion" placeholder="Nombre de la Canción" required>
                            </div>
                          </div>
                          <div class="actions">
                      ...
                      <!-- modal Eliminar Canciones -->
                        <div class="ui eliminar basic modal">
                          ...
                          <div class="content">
                            <p>¿Estás seguro que quieres eliminar esta canción? si la eliminas no podrá ser recuperada y los de la banda se cagaran de todo</p>
                          </div>
                          <div class="actions">
